"""One-shot generator: value-chain-matrix-pptx の roleup curated template を
...
SRC = os.path.join(SKILL_DIR, "assets", "stellar_aiz", "value-chain-matrix-template.pptx")
DST = os.path.join(SKILL_DIR, "assets", "roleup", "value-chain-matrix-template.pptx")
