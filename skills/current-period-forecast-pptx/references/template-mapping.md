...
forecast-template.pptx（company-overview-template.pptxベース）を検査して確認済み（2026-04）。
...
|---|---|---|---|
| メインメッセージ | `Title 1` | PLACEHOLDER | Main Message（左寄せ、24pt Bold、テーマフォント継承） |
| チャートタイトル | `Text Placeholder 2` | PLACEHOLDER | Chart Title（左寄せ、テーマフォント継承） |
| コンテンツエリア | `Content Area` | AUTO_SHAPE | HTML screenshot挿入先（当期着地見込みテーブル） |
